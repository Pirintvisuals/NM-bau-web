...
function site_chrome() {
  ...
  $navFallback = '<nav id="nav"><div class="nav-inner"><a href="/" class="nav-logo"><span class="brand"><span class="brand-wordmark"><span class="brand-name">NM BAU</span><span class="brand-tag">Sopron</span></span></span></a><ul class="nav-links"><li><a href="/szolgaltatasok.html">Szolgáltatások</a></li><li><a href="/referenciak.html">Referenciák</a></li><li><a href="/blog/">Blog</a></li><li><a href="/rolunk.html">Rólunk</a></li><li><a href="/ingyenes-felmeres.html">Kapcsolat</a></li></ul><a href="/ingyenes-felmeres.html" class="btn btn-primary nav-cta">Azonnali árajánlat</a></div></nav>';
